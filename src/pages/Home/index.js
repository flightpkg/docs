...
import flightpkgTerminal from '../../components/Terminal';
      ...
      <header className={classnames('hero', styles.heroBanner)}>
        <div className="container">
          <h1 className={classnames('hero__title', styles.title)}>
            ...
            <strong>swift</strong>, <strong>reliable</strong> and <strong>multi-language</strong> package manager.
          ...
          <div className="container">
            <div className="row">
              ...
              <div className={classnames('col col--8')}>
                <flightpkgTerminal version={version} />
              </div>
            </div>
          </div>
        </section>
